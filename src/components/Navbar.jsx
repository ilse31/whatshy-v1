        ...
        <div className='py-3 w-full px-4 top-0 font-poppins font-normal text-[#00AC94]  border-b shadow-sm top-0 sticky bg-white z-50' >
            <div className="flex justify-between flex-col md:flex-row max-w-screen-2xl mx-auto">
                ...
                <motion.div variants={ {
                    ...
                    <Link to={ user ? "/dashboard/personal-messages" : "/auth/login" } className='bg-[#00AC94] text-white px-6 py-2 rounded-full hover:bg-[#06d7bc] text-center transition-colors ease-in-out duration-300'>{ user ? "Profile" : "Login" }</Link>
