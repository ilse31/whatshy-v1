...
export default function Modal ( { children, modal_title, button_title } )
{
    ...
    return (
        <>
            <button
                className="bg-[#01D2B3] text-white capitalize active:bg-[#017765] font-normal text-sm px-3 py-2 rounded shadow hover:shadow-lg outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150"
                type="button"
